...
class FileParser:
    ...
    def get_parts_from_args(self) -> tuple[Path, str, str, bool]:
    ...
    @staticmethod
    def handle_valid_args(args) -> tuple[Path, str, str, bool]:
        ...
        logging.info(
            f"Proceeding with filepath: {filepath}, title model: {title_model}, episode model: {episode_model}, dry run: {args.dry_run}")
        return filepath, title_model, episode_model, args.dry_run
